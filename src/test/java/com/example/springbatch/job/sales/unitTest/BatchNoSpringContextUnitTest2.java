...
import com.example.springbatch.job.BatchOnlyJdbcReaderTestConfiguration;
...
import static com.example.springbatch.job.BatchOnlyJdbcReaderTestConfiguration.FORMATTER;
...
public class BatchNoSpringContextUnitTest2 {
    ...
    public void 기간내_Sales가_집계되어_SalesSum이된다() throws Exception {
        ...
        JdbcPagingItemReader<SalesSum> reader = job.batchReader(orderDate.format(FORMATTER)); // (2)
