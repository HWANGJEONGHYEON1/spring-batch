...
public class BatchJdbcTestConfiguration {
    ...
    @Bean
    public Job batchJdbcTestJob() throws Exception {
    ...
    @Bean
    @StepScope
    public JdbcPagingItemReader<SalesSum> batchReader(@Value("#{jobParameters[orderDate]}") String orderDate) throws Exception {
